...
<script type="text/javascript">
    ...
    function print() {
      ...
      window.open("<?= base_url() ?>Pengeluaran/print/"+tanggal_awal+"/"+tanggal_akhir+"/"+i_jenis);
    }
    ...
    function load_data() {
      ...
      if(i_jenis == "") {
        ...
        $("#table1").DataTable({
            ...
            "serverSide" : true,
            ajax :{
                url: "<?= base_url('Pengeluaran/load_data/') ?>"+i_jenis+"/"+tanggal_awal+"/"+tanggal_akhir
            },
            "columns" :[
                {"name" : "id"},
                {"name" : "kode"},
    ...
    function load_select_jenis(){
        ...
        $('#i_jenis').select2({
            ...
            allowClear: true,
            ajax: {
                url: '<?php echo site_url("Pengeluaran/get_select_jenis/"); ?>'+1,
                dataType: 'json',
                delay: 100,
                cache: true,
                data: function (params) {
